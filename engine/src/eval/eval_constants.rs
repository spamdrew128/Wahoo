...
pub const PAWN_STORM_PST: Pst = Pst::new([
  ...
  s(-33, -74), s(-33, -89), s(17, -81), s(14, -59), s(26, -57), s(18, -64), s(-7, -97), s(-32, -82), 
  s(33, -55), s(34, -46), s(49, -52), s(18, -30), s(17, -21), s(29, -42), s(37, -52), s(21, -32), 
  s(8, -23), s(5, -10), s(10, -11), s(6, -2), s(0, 1), s(8, -9), s(0, -7), s(3, -10), 
  s(-5, -5), s(-9, 0), s(0, -1), s(-3, 4), s(-12, 6), s(-3, 1), s(-6, 1), s(-2, -2), 
  s(-10, 0), s(-19, 4), s(-10, 3), s(-13, 6), s(-15, 6), s(-3, 3), s(-14, 6), s(-10, 3), 
  s(-10, -1), s(-17, 7), s(-3, 0), s(-17, 8), s(-12, 6), s(-4, 5), s(-9, 3), s(-15, 2), 
  s(1, 1), s(1, 1), s(1, 1), s(1, 1), s(1, 1), s(1, 1), s(1, 1), s(1, 1), 
]);
